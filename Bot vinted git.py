...
# Auto installation des modules nécessaires
...
# Gestion de la mémoire, pour éviter les répétitions d'articles déjà vus
# Mémoire
def charger_cache():
        ...
        try:
            ...
            for item in items:
                ...
                if item_id not in articles_deja_vus:
                    # Extraction prix combiné (base + frais de service + port)
